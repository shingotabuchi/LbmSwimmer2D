...
public class LbmSwimmer2D : MonoBehaviour
{
    ...
    //                 } 
    //             }
    //             float boundaryPointTheta = roundParticles[n].theta + m * 2f * Mathf.PI / roundParticles[n].perimeterPointCount;
    ...
    //             roundParticles[n].perimeterFluidVel[m,0] += surfaceVelocity[0];
    //             roundParticles[n].perimeterFluidVel[m,1] += surfaceVelocity[1];
